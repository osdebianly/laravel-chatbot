...
<head>
    ...
    <script src="{{ asset('vendor/chatbot/js/jquery.js') }}" type="text/javascript"></script>
    <link rel="stylesheet" href="{{asset('vendor/chatbot/css/main.css')}}" type="text/css"/>
...
<center>
    <div id="box1">
        ...
        <div>
            <br>
            <a target="_blank" href="api.php?requestType=talk&input=hello">api</a>
        </div>
    </div>
